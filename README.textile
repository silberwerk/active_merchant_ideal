...
<pre>
ActiveMerchant::Billing::IdealGateway.acquirer = :ing # Other banks preloaded are :abnamro, :rabobank, :simulator (http://www.ideal-simulator.nl/ideal-simulator-instellingen.html)
